...
describe("channel", () => {
	...
	it("toHTML", ({ expect }) => {
		expect(toHTML(markdown)).toBe(`<span class="duc_channel"><span class="duc_nowrap">
...
</span><span class="duc_channel_name">518467470894563345</span></span>`);
	});
