...
export class OriginalDiscordUserCard implements Renderer {
	...
	constructor(public readonly parent: Element) {
		...
		this.children = {
			prefetch: new PrefetchRenderer(this.parent, "card"),
			banner: new BannerRenderer(this.containers.inner, "card"),
			profileEffects: new ProfileEffectsRenderer(this.containers.inner, this.parent),
			avatar: new AvatarRenderer(this.containers.inner, "card"),
			badges: new BadgesRenderer(this.containers.inner, "card"),
