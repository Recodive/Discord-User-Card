...
<template>
	<svg
		...
		viewBox="0 0 340 120"
		style="min-width: 340px; min-height: 120px"
	>
		<mask id="mask_avatar">
		...
		<foreignObject
			...
			height="100%"
			overflow="visible"
			mask="url(#mask_avatar)"
		>
			<div
				class="banner bannerPremium"
				:style="{
					'background-image':
						'url(&quot;https://cdn.discordapp.com/banners/223238938716798978/92dfc45d41b3936613f5882df1aa45a6.png?size=480&quot;)',
